...
const Chat = () => {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4.2rem)] flex-1 flex-col overflow-y-auto border-4 border-blue-500 bg-blue-100">
      <div className="absolute inset-x-0 top-0 z-50 bg-white">header</div>
